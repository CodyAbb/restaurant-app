...
public interface DeskRepository extends JpaRepository<Desk, Long> {
    ...
    @Query(value = "SELECT * FROM desks LEFT OUTER JOIN bookings ON desks.id = bookings.desk_id AND bookings.number_of_people = '2'", nativeQuery = true)
    List<Desk> getAllBookingsForAGivenDesk();
}
