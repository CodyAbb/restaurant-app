...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        Desk desk4 = new Desk(2, 1, true);
        deskRepository.save(desk4);

        Desk desk5 = new Desk(2, 1, false);
        deskRepository.save(desk5);

        Desk desk6 = new Desk(4, 1, false);
        deskRepository.save(desk6);

        Desk desk7 = new Desk(4, 1, false);
        deskRepository.save(desk7);

        Desk desk8 = new Desk(4, 1, false);
        deskRepository.save(desk8);

        Desk desk9 = new Desk(4, 1, false);
        deskRepository.save(desk9);

        Desk desk10 = new Desk(4, 1, false);
        deskRepository.save(desk10);

        Desk desk12 = new Desk(4, 1, false);
        deskRepository.save(desk12);

        Desk desk13 = new Desk(6, 1, false);
        ...
        Booking booking3 = new Booking("19:00", "2020-03-06", 6, customer1, desk13);
        bookingRepository.save(booking3);

        Booking booking4 = new Booking("23:50", "2015-03-07", 6, customer1, desk13);
